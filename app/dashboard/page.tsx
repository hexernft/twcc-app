      ...
      <div className="mx-auto max-w-6xl">
        <header className="mb-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button className="rounded-full bg-white px-4 py-2 text-sm font-semibold text-[#101B3D] shadow-sm">
              🔔
            </button>

            <button
              onClick={handleLogout}
              className="rounded-full border border-[#101B3D] px-4 py-2 text-sm font-semibold text-[#101B3D]"
            >
              Logout
            </button>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <section className="space-y-6 lg:col-span-2">
            <div className="rounded-3xl bg-[#101B3D] p-6 text-white shadow-sm">
